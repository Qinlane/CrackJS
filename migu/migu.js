...
rsaFingerprint = function() {
    ...
    return {
        details: f, // fingerPrintDetail
        result: h // fingerPrint
    }
}

// loginID 和 enpassword 的加密方式相同
function getPwd(pwd) {
    c = new RSAKey;
...
function getFinger() {
    c = ["Mozilla/5.0 (Windows NT 6.1; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/80.0.3987.132 Safari/537.36"]
    result = x64hash128(ua.join('~~~'), 31)
    return result
}
